...
class FinancialDataset(Dataset):
    def __init__(self, data_path):
        ...
        Each tensor is expected to have shape (181,) where:
...
class MultiModalMLP(nn.Module):
    def __init__(self, device='cuda'):
        ...
        # Topic vector path with increased complexity (updated for 100 elements)
        self.topic_path = nn.Sequential(
            nn.Linear(100, 256),  # Changed from 30 to 100 input features
            nn.LeakyReLU(),
            nn.Dropout(0.2),
            nn.Linear(256, 384),  # Increased intermediate dimension
            nn.LeakyReLU(),
            nn.Dropout(0.2),
            ResidualBlock(384),
            nn.Linear(384, 256),
...
if __name__ == "__main__":
    ...
    train_model(
        ...
        checkpoint_dir="/Users/daniellavin/Desktop/proj/MoneyTrainer/EX_CHECK/checkpxE1",
        report_path="/Users/daniellavin/Desktop/proj/MoneyTrainer/EX_CHECK/1X_report.txt",
        params=params
    )