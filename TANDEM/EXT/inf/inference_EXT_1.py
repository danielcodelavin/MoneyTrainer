...
class PrecisionFocusedMLP(nn.Module):
    def __init__(self):
        ...
        self.topic_path = nn.Sequential(
            nn.Linear(100, 128),  # Changed from 30 to 100
            nn.LeakyReLU(),
            nn.Dropout(0.2),
            nn.Linear(128, 256),
            nn.LeakyReLU(),
...
if __name__ == "__main__":
    ...
    for date in dates:    
        main(
        csv_path="/Users/daniellavin/Desktop/proj/MoneyTrainer/ENERGY_stockscreen.csv",
        bertopic_model_path="/Users/daniellavin/Desktop/proj/MoneyTrainer/x_preprocess/EX/EX1_BERTOPIC_MODEL_100.pt",
        checkpoint_path="/Users/daniellavin/Desktop/proj/MoneyTrainer/TANDEM/EXT/check/checkpoint_epoch_1400.pt",
        results_base_path="/Users/daniellavin/Desktop/proj/MoneyTrainer/TANDEM/EXT/results",
